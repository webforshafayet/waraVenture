jQuery(function($) {
    ...
    window.ScrollEffects = function() {
        ...
        if (isMobile()) {
            ...
            $('.smooth-scroll main, .infinity-lists-holder, .infinity-lists-wrapper, nav, #canvas-slider, #showcase-slider-holder, #showcase-carousel-holder, #hero.has-image #hero-caption, #hero-image-wrapper, .thumb-container, .thumb-page, .next-project-image-wrapper').css({
                'height': winHeight
            });
            ...
            if ($("#itemsWrapper").hasClass("scale-fitthumbs")) {
                ...
                function addListeners(tile, page, url) {
                    ...
                    url.addEventListener("click", function() {
                        ...
                        gsap.to('#hero, #show-filters, .item, .item-caption-wrapper, #page-nav, footer, .fadeout-element', {
                            duration: 0.3,
                            opacity: 0,
                            delay: 0,
                            ease: Power2.easeIn
